% Compute bids in counterfactual fixed royalty first-price auction, t=6

cd(fileparts(mfilename('fullpath')))
addpath('functions')

clear; clc;
load('../calculations/Increase_t_values_am.mat') % t=6 lease values
...
save('../calculations/Increase_t_bids_am.mat','t','R','frb','winner')